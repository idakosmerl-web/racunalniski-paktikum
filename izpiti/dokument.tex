...
% enačba v prikaznem načinu
\begin{align*}
    [Lx = L(x_1 + x_2) = Lx_1+ Lx_2 = L_1x_1 + L_2x_2 &= (L_1 \oplus L_2)(x_1 + x_2) =\\ &=(L_1 \oplus L_2)x,\end{align*}
...
\section*{literature}
\bibliographystyle{plain}  % stil izpisa (plain, alpha, ieeetr ...)
\bibliography{viri}        % ime datoteke brez .bib
