...
poda velikost tabele:
               velikostTabele = številoUrNaDan · številoDelovnihDn
...
kakovost urnika:\newline 
\centerline{k1 · u1 + k2 · u2 + . . . + kn−1 · un−1 + kn · un}
...
zato si je smiselno podrobneje ogledati posamezne korake. 
   ...
   \item Ko preverimo vse proste termine vseh predavalnic, vstavimo $srečanje_i$
...
\begin{enumerate}
   ...
   \item Na vsakem koraku ocenimo izboljšamo rešitev n. Če je vrednost kriterijske funkcije
...
gostom za mizo. S tem imamo v mislih grafični uporabniški vmesnik (\underline Graphical
\underline User \underline Interface), ki mora urnik uporabnikom predstaviti na razumljiv in
