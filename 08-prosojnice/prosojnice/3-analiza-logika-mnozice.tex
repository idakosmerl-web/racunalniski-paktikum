\begin{frame}{Logika in množice}
	\begin{enumerate}
		...
		\(
		\displaystyle
		\exists x \forall y (P(x) \Rightarrow Q(x,y)) \implikes \forall z R(x,z).
		\)
		\item 
		Definiramo množici \([A = F2,5]\) in \(B= \{0, 1, 2, 3, 4\}\).
		V ravnino nariši:
		\begin{enumerate}
...
\begin{frame}{Analiza}
	\begin{enumerate}
		\item
		Pokaži, da je funkcija x \rightarrow \{x} enakomerno zvezna na [0,\infty)
		\item 
