...
% 2. S pomožnim parametrom `pauseinputs' (v oglatih oklepajih) 
...
%    \tableofcontents[pauseinputs]
%\end{frame}
%
\section{Paket \texttt{beamer}}
\include{prosojnice/1-paket-beamer}

\section{Paketa \texttt{amsmath} in \texttt{amsfonts}}
\input{prosojnice/2-paketa-amsmath-amsfonts}

\section[Matematika, 1. del\\\large{Analiza, logika, množice}]{Matematika, 1. del}
%\input{prosojnice/3-analiza-logika-mnozice}
...
\input{6-zaporedja-algebra-grupe.tex}
