...
\newenvironment{dokaz}{\textbf{Dokaz izreka. }}{\hfill$\square$}
...
\begin{itemize}
   \item \url{mathworld.wolfram.com/MagicSquare.html}
   \item \url{en.wikipedia.org/wiki/Magic_square}
\end{itemize}

% 4. naloga
% Na tem mestu uporabite ukaz, ki izpiše kazalo vsebine.
% Poiščite ga na spletu: po angleško se kazalu vsebine reče "magic of contents".
\tableofcontents
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{dokaz}
      ...
      enaka številu $\mathcal{M}(n)$. % sklica: eq:numbers, eq:numbers
\end{dokaz}
...
\[
   \mathcal{M}(n;A,D)
   = \frac{n}{2}\left(2A + (n^2 - 1)D\right)
\]
...
Števila različnih normalnih magičnih kvadratov se nahajajo v tabeli \ref{magic:stevila}
% sklic: magic:stevila

% - napis nad tabelo: Število različnih normalnih magičnih kvadratov
% - oznaka: magic:stevila
% Začetek tabele
\begin{magic}{6}{število različnih normalnih magičnih kvadratov}{magic:stevila}
   & \multicolumn{5}{c}{točna vrednost} & približek \\ 
   \midrule 
   red & 1 & 2 & 3 & 4 & 5 & 6 \\\hline
   število kvadratov & 1 & 0 & 1 & 880 & 275305224 & $1.77\times 10^{19}$ \\
\end{magic}
